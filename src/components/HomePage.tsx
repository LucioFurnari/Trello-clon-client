...
export default function HomePage() {
  return (
    <main className="flex flex-col justify-center min-h-[calc(100vh-56px)] p-6 bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500">
      ...
      <Link className="bg-blue-600 text-white py-3 mt-6 rounded w-full inline-block text-center font-medium" href={"/register"}>Sign up - it’s free!</Link>
      <Image className="mt-6" src={"/images/TrelloUICollage.png"} alt={"An illustration showing different features of a Trello board"} width={500} height={460}/>
    </main>
  )
}