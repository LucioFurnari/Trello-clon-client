  ...
  return (
    <form className="flex flex-col mt-8 p-4 w-full md:max-w-2xl" action={formAction}>
      ...
      <p className="mx-auto mt-4">{state?.message}</p>
      {
        state.success &&
        <>
        <p className="text-center text-2xl">User logged successful</p>
...
export function MaterialSymbolsCheck(props: SVGProps<SVGSVGElement>) {
  return (
    <svg className=" mx-auto w-10 h-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="m9.55 18l-5.7-5.7l1.425-1.425L9.55 15.15l9.175-9.175L20.15 7.4z"></path></svg>
  )
}